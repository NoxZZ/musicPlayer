...
def mood(choice):
    while True:
            if choice == 1:
                ...
                wb.open('https://www.youtube.com/playlist?list=PLKe9CVqEUDMEYvAy57HkCNfVBprD18cA-')
            elif choice == 3:
                wb.open('https://www.youtube.com/playlist?list=PLKe9CVqEUDMEcpW3Zy2KJWTcPpTGtKAck')
            elif choice == 4:
                wb.open('https://www.youtube.com/playlist?list=PLKe9CVqEUDMH77Bk07v8esKG5L83UOFjH')
            else :
